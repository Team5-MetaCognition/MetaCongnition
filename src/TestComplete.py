...
class TestComplete(BaseImage):  
    def __init__(self, parent, controller):
        ...
        self.test_complete_btn = ctk.CTkButton(self, text="결과 보기", command=self.move_ResultScreen,font=("나눔고딕", 30, "bold"), width=150, height=50, fg_color="#fae375", hover_color="#b09307",text_color="#000000")
