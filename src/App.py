...
class MetacognitionTestApp(tk.Tk):
    def __init__(self):
        ...
        for Frame in (StartPage, HowToPage, UserInfo, ShowWord, EstimatedNumber):  # 여러 페이지(Frame)를 초기화
        ...
        self.swtich_frame("StartPage")  # 시작 페이지를 표시
    
    def swtich_frame(self, page_name):
